...
training_set = train_datagen.flow_from_directory('dataset/training_set',    #training of CNN
                                                 target_size = (64, 64),
                                                 batch_size = 32,
                                                 class_mode = 'binary')
...
classifier.fit_generator(training_set,                  
                         ...
                         validation_steps = (2000/32))   #images in our test set
...
img = imread('dataset/single_prediction/cat_or_dog_1.jpg') #make sure that path_to_file contains the path to the image you want to predict on. 
